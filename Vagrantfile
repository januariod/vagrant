...
Vagrant.configure('2') do |config|
  ...
  config.vm.define 'phpweb' do |phpweb|
    ...
    phpweb.vm.network 'public_network', bridge: 'enp3s0', ip: '192.168.1.25'
  ...
  config.vm.define 'mysqlserver' do |mysqlserver|
    ...
    mysqlserver.vm.network 'public_network', bridge: 'enp3s0', ip: '192.168.1.22'
  ...
  config.vm.define 'ansible' do |ansible|
    ...
    ansible.vm.network 'public_network', bridge: 'enp3s0', ip: '192.168.1.26'
